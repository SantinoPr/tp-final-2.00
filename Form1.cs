...
namespace tp_final_2
{
    ...
    {
        //Instanciando las clases y los objetos
        ...
        private void button2_Click(object sender, EventArgs e) //Boton añadir Local
        {
            ...
            {
                //ingresar los nombres y numeros de los jugadores
                ...
                //Se muestra los datos de lo jugadores locales
        ...
        private void button3_Click(object sender, EventArgs e) //Boton añadir visitante
        {
            ...
            if (añadir.ShowDialog() == DialogResult.OK)
            {
                ...
                //Se muestra los datos de lo jugadores visitantes
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 4; i <= 0; i--)
                {
                    r.listBox2.Items.Add(String.Format("Puntos:"+Local.PuntosJuga(i)+" "+Local.Nom(i)));
                }
